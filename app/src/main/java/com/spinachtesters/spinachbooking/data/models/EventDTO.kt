...
fun EventDTO.toDomain(eventDetails: EventDetails) = Event(
    ...
    startTime = Instant.ofEpochMilli(this.startTime).atZone(ZoneId.of("UTC")).toLocalDateTime(),
    endTime = Instant.ofEpochMilli(this.endTime).atZone(ZoneId.of("UTC")).toLocalDateTime(),
